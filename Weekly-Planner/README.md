...
- **Gantt mobile — grid com rolagem horizontal**: removida a lista vertical por dia; o Gantt agora usa o mesmo grid do desktop com `overflow-x:auto` (grade 500px mínima no mobile, rola horizontalmente para ver todos os dias).
